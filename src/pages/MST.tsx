...
const MST= () => {
  ...
  return (
    <div  className = "general" style = {{width : "60vw", display : "flex", justifyContent : "center"}}>
          ...
          <p>A minimum spanning tree is a subgraph with every vertex of the graph that is also a tree.</p>
          <p>We will use Kruskal's Algorithm and Prim's Algorithm to calculate the minimum spanning tree.</p>
          <p>Here, an adjacency matrix is used to represent a graph.</p>
